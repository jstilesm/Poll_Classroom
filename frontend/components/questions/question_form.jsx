      ...
      <div className="question-form-container">
        ...
        <form className="create-form" onSubmit={this.handleSubmit}>
          ...
          <label>
            Response_Limit
            <input
              className="response-input input"
              type="number"
              value={this.state.response_limit}
              onChange={this.update("response_limit")}
            />
          </label>
          ...
          <label className="closed-label">
            ...
            <input
              ...
              name="closed?"
              onChange={this.update("closed")}
            />
          </label>
          <label className="registered-label">
            Allow_Unregistered?
            <input
              className="registered-input"
              type="checkbox"
              value={this.state.allow_unregistered}
              name="allow_unregistered?"
              onChange={this.update("allow_unregistered")}
            />
          </label>
